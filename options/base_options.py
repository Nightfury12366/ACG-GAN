...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot',  default='./datasets/afhf',  # required=True,
                            help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--name', type=str, default='sky_gan_v17_afhf',
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='sky_gan_17',  # model 
                            help='chooses which model to use. [sky_gan | sky_gan_2 | sky_gan_3 | sky_gan_4]')
        ...
        parser.add_argument('--netG', type=str, default='SKY_G_v17',
                            help='specify generator architecture [SKY_G | SKY_G_v2 | SKY_G_v3 | SKY_G_v4]')
